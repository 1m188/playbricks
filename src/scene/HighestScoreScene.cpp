...
HighestScoreScene::HighestScoreScene(Window *parent) : Scene(parent)
{
}
...
void HighestScoreScene::init()
{
    ...
    highestScoreLabel->setText(QString::number(Config::getInstance()->getHighestScore()) + tr(u8"分") + "     " + Config::getInstance()->getHighestScorePlayer());
